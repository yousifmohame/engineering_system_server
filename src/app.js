...
app.get('/iclock/cdata', zktecoController.handshake);

// 2. مسار استقبال البصمات (عندما يبصم الموظف، يرسل الجهاز البيانات هنا)
app.post('/iclock/cdata', zktecoController.receiveData);

// 3. مسار إرسال الأوامر للجهاز (اختياري)
app.get('/iclock/getrequest', zktecoController.getCommands);
